...
import { commercial, suites, services, apartments } from "./Constants/constant";
...
export default function App() {
    ...
    const [onWelcome, setOnWelcome] = useState(false);
            ...
            <div className="App">
                <Router>
                    <div
                        ...
                        style={onWelcome ? { marginRight: -30 } : { marginRight: -12 }}
                    >
                        <a
                    ...
                    <Switch>
                        <Route path="/" exact>
                            <WelcomeScreen setOnWelcome={setOnWelcome} />
                        </Route>
                        <Route path="/home-commercial">
                            <HomeScreen selected={commercial} setOnWelcome={setOnWelcome} />
                        </Route>
                        <Route path="/home-services">
                            <HomeScreen selected={services} setOnWelcome={setOnWelcome} />
                        </Route>
                        <Route path="/home-suites">
                            <HomeScreen selected={suites} setOnWelcome={setOnWelcome} />
                        </Route>
                        <Route path="/home-apartments">
                            <HomeScreen selected={apartments} setOnWelcome={setOnWelcome} />
                        </Route>
                        <Route path="/features">6
                            <ServicesScreen setOnWelcome={setOnWelcome} />
                        </Route>
                        <Route path="/location">
                            <LocationScreen setOnWelcome={setOnWelcome} />
                        </Route>
                        <Route path="/construction_update">
                            <ConstructionUpdateScreen setOnWelcome={setOnWelcome} />
                        </Route>
                        <Route path="/about-us">
                            <AboutUsScreen setOnWelcome={setOnWelcome} />
                        </Route>
                    </Switch>
                </Router>
            </div>
