...
import services__background__Img1 from "../Assets/services__background__Img1.jpg";
...
export default class LocationScreen extends Component {
  ...
  sendContactRequest = async () => {
    ...
    if (this.state.name === "") {
      ...
      CustomError("Email missing");
      this.setState({
        isLoading: false,
      });
      return null;
    } else if (this.state.message === "") {
      CustomError("message missing");
      this.setState({
        isLoading: false,
      });
      return null;
              ...
              <div className="contact__container__content__form__left">
                ...
                {this.state.isSent ? (
                  <div className="contact__container__content__form__info">
                    Thank you {this.state.name} for contacting us, Our manager
                    will contact you soon.
                    <br></br>
                    <br></br>
                    <button
                      className="heading contact__container__wrapper__right__button"
                      onClick={() => this.resetInoutFields()}
                    >
                      Request Again
                    </button>
                  </div>
                  ...
                  <>
                    ...
                    <button
                      className="heading contact__container__content__form__button"
