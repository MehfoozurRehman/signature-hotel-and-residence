          ...
          if (result.length > 0) {
            ...
            unsortedMilestoneList.sort(
              (a, b) =>
                ...
                Date.parse(b.milestone_expected_completion_date.toString())
            );
            this.setState({
              mileStonesList: unsortedMilestoneList,
              constructionUpdateTitle: unsortedMilestoneList[0].milestone_title,
              constructionUpdateContent:
                unsortedMilestoneList[0].milestone_description,
              constructionUpdateImg:
                unsortedMilestoneList[0].milestone_image_url != null
                  ? process.env.REACT_APP_BASEURL +
                    unsortedMilestoneList[0].milestone_image_url
                  : work__img,
            });
          }
        }
              ...
              <div className="construction__update__container__wrapper_content__carousel__progress__controls">
                ...
                {this.state.mileStonesList.map((milestone, milestoneIndex) => (
                  <ConstructionUpdateControl
                    ...
                    date={moment(
                      milestone.milestone_expected_completion_date
                    ).format("MMMM Do YYYY")}
                    onClick={() => {
                      this.setState({
                        ...
                        constructionUpdateImg:
                          milestone.milestone_image_url != null
                            ? process.env.REACT_APP_BASEURL +
                              milestone.milestone_image_url
                            : work__img,
