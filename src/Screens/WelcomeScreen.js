...
import welcome_background from "../Assets/main__backgound.png";
...
export default function WelcomeScreen({ setOnWelcome, passingHistoryFromWelcomeToHome }) {
    let history = useHistory()
    useEffect(() => {
        setOnWelcome(true);
    }, []);

    var REATIL_SHOP_PATH = "/home-apartments"
    var HOTEL_SERVICES_PATH = "/home-services"
    var BUISNESS_CENTER_PATH = "/home-commercial"
    var HOTEL_SUITES_PATH = "/home-suites"

    const navigateToHomeScreen = (value) => {

        if (value === "retail_shop") {
            localStorage.setItem("category_id", commercial);
            history.push(REATIL_SHOP_PATH);
        } else if (value === "hotel_services") {
            localStorage.setItem("category_id", services);
            history.push(HOTEL_SERVICES_PATH);
        }
        else if (value === "business_center") {
            localStorage.setItem("category_id", suites);
            history.push(BUISNESS_CENTER_PATH);
        }
        else if (value === "hotel_suites") {
            localStorage.setItem("category_id", apartments);
            history.push(HOTEL_SUITES_PATH);
        }
    }
    return (
        <>
                ...
                <div className="welcome__container__wrapper">
                    <div className="welcome__container__wrapper__content">
                        <div className="welcome__container__wrapper__content__left">
                            <div
                                onClick={() => navigateToHomeScreen("retail_shop")}
                            ...
                            <div
                                onClick={() => navigateToHomeScreen("hotel_services")}
                                className="welcome__container__wrapper__link"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div
                                onClick={(event) => navigateToHomeScreen("business_center")}
                                className="welcome__container__wrapper__link"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                ...
                                <span>BUISNESS CENTER</span>
                            </div>
                            <div
                                onClick={(event) => navigateToHomeScreen("hotel_suites")}
                                className="welcome__container__wrapper__link"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
